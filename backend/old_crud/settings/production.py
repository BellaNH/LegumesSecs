...
# Always allow Netlify frontend (exact + with trailing slash for browser variance)
NETLIFY_ORIGIN = 'https://legumessecs.netlify.app'
for o in (NETLIFY_ORIGIN, NETLIFY_ORIGIN + '/'):
    if o not in CORS_ALLOWED_ORIGINS:
        CORS_ALLOWED_ORIGINS.append(o)

# Regex fallback: match Netlify origin with or without trailing slash
CORS_ALLOWED_ORIGIN_REGEXES = [
    r'^https://legumessecs\.netlify\.app/?$',
]
